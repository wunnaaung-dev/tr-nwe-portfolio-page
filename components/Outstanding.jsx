...
const Outstanding = () => {
  ...
  return (
    <section className="my-4" id="testimonials">
      ...
      <p className="w-full md:w-1/2 text-center mx-auto my-2">
        Your dedication and hard work have not gone unnoticed. It is my greate
        plesuer to reward the outstanding students in the exams.
      </p>
      <Swiper
        spaceBetween={10}
        navigation={true}
